...
export const REFRESH_COOKIE_DURATION = process.env.REFRESH_COOKIE_DURATION || 3.154e10; // 1 year
...
export const MONO_DB_CONNECTION_STRING =
  process.env.MONO_DB_CONNECTION_STRING || `mongodb://localhost:27017/${DB_NAME}`;
